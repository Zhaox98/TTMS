 ...
 *
 */
public class MyDateJbutton extends JButton {
	private DateChooser dateChooser = null;
	private String preLabel = "";

	public MyDateJbutton() {
		this(getNowDate());
	}

	public MyDateJbutton(SimpleDateFormat df, String dateString) {
		this();
		setText(df, dateString);
	}

	public MyDateJbutton(Date date) {
		this("", date);
	}

	public MyDateJbutton(String preLabel, Date date) {
		if (preLabel != null)
	...
	private class DateChooser extends JPanel implements ActionListener,
		...
		void showDateChooser(Point position) {
			Frame owner = (Frame) SwingUtilities.getWindowAncestor(MyDateJbutton.this);
