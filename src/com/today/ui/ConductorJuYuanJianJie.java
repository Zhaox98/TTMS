...
import com.xy.today.mycontrols.AnimationImagePanelYuanGong;
 ...
 *
 */
public class ConductorJuYuanJianJie extends JTabbedPane{
	...
	private JPanel jingDianDianYing(){
		...
		/**
		 * 电影历史  数据进口  本来  按照 习惯 老夫准备是写成方法的   但是  懒  所以 老夫
		 * 就  直接在  该方法中 加入数据
		 */
		...
		JPanel jPanel = new AnimationImagePanelYuanGong(imagePaths);
		jPanel.setOpaque(false);
